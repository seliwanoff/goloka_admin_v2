    ...
    <section className="py-20">
      <div className="wrapper">
        ...
        <div className="relative mt-6 w-full">
          <div className="absolute left-0 top-0 z-10 h-full w-[100px] bg-[linear-gradient(to_right,white_50%,transparent)] xl:w-[300px]" />
          <div className="absolute right-0 top-0 z-10 h-full w-[100px] bg-[linear-gradient(to_left,white_50%,transparent)] xl:w-[300px]" />
