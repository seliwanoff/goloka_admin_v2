      ...
      <div className="wrapper">
        <div className="flex w-full flex-col items-center gap-2">
          <div className="text-primary-600 mb-5 flex items-center justify-center gap-2 rounded-full bg-violet-50 px-6 py-2 text-sm font-bold">
            <div className="inline-flex items-center space-x-2 text-main-100">
              <Sparkle size={16} />
              <span className="text-sm">Testimonials</span>
            </div>
          </div>

          <h2 className="text-center text-2xl font-bold md:text-[2rem]">
            See what our &nbsp;
            <span className="text-main-100">Users</span> are saying
          </h2>
        </div>
        <div className="relative mt-6 w-full">
          <div className="absolute left-0 top-0 z-10 h-full w-[100px] bg-[linear-gradient(to_right,white_50%,transparent)] xl:w-[200px]" />
          <div className="absolute right-0 top-0 z-10 h-full w-[100px] bg-[linear-gradient(to_left,white_50%,transparent)] xl:w-[200px]" />
            ...
            {Array.from({ length: 8 }, (data, idx) => (
              ...
              >
                ...
                <p className="text-gray-600 group-hover:text-gray-800">
                  ...
                  beneficial for a newcomer like me. The content is presented in
                  a way that&apos;s understandable, and the practical exercises
                  have helped reinforce my understanding.
                </p>
